...
import grpc
import tgis_grpc_client.generation_pb2_grpc
import socket
import ssl
import sys
...
class TgisGrpcClient:
    def __init__(
        ...
        *,
        ...
        self.generation_service_stub = tgis_grpc_client.generation_pb2_grpc.GenerationServiceStub(
            self._channel
        )

    def make_request(self, text: str, model_id: str = "flan-t5-small", max_new_tokens=128):
        request = tgis_grpc_client.generation_pb2_grpc.generation__pb2.BatchedGenerationRequest(
            model_id=model_id,
            requests=[tgis_grpc_client.generation_pb2_grpc.generation__pb2.GenerationRequest(text=text)],
            params=tgis_grpc_client.generation_pb2_grpc.generation__pb2.Parameters(
                   method=tgis_grpc_client.generation_pb2_grpc.generation__pb2.GREEDY,
                   stopping=tgis_grpc_client.generation_pb2_grpc.generation__pb2.StoppingCriteria(
