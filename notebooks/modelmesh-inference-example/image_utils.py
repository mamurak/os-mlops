...
def draw_image_and_faces(original_image, confidences, boxes):
    boxes, labels, probs = _get_face_boxes(
...
def _get_face_boxes(width, height, confidences, boxes, prob_threshold, iou_threshold=0.5, top_k=-1):
    """
